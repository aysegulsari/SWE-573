...
from . import views
from accounts.views import RecipeListView,RecipeDetailView,RecipeJustDetailView
...
urlpatterns=[
    ...
    #path('list_recipes/update/<int:pk>',RecipeDetailView.as_view(),name='recipe_update_details'),
